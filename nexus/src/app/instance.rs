...
impl super::Nexus {
    ...
    pub(crate) async fn instance_serial_console_data(
        ...
        let client = self.propolis_client_for_instance(instance_lookup).await?;
    ...
    // TODO: Technically the stream is two way so the user of this method can
    // modify the instance in some way. Should we use different permissions?
    ...
    async fn propolis_client_for_instance(
        ...
        eprintln!("HIGH VOLTAGE {:?}", socket_addr);
